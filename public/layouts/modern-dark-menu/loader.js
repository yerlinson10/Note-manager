    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '../src/assets/img/cork-logo.png',
                    lightLogo: '../src/assets/img/cork-logo.png'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/cork-logo.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
